...
class Task(models.Model):
    ...
    queued_by_username = models.CharField(max_length=300, null=True)
    completed_by_user_id = models.IntegerField(blank=True, null=True)
    completed_by_username = models.CharField(max_length=300, null=True)
    task_title = models.CharField(max_length=64, default="default task title")
    task_description = models.CharField(max_length=300)
    task_address = models.CharField(max_length=300, null=True)
    task_phone = models.CharField(max_length=20, null=True)
    task_email = models.CharField(max_length=60, null=True, blank=True)
